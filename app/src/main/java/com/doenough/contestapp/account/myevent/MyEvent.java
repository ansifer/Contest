...
public class MyEvent {
    ...
    public MyEvent(String name, long time, String key, String userKey, Uri imageUrl, String nameOfCreator, String uidOfCreator) {
        mName = name;
        mTime = time;
        mKey = key;
        mUserKey = userKey;
    ...
    public MyEvent(String name, long time, String key, String userKey, String nameOfCreator, String uidOfCreator) {
        mName = name;
        mTime = time;
        mKey = key;
        mUserKey = userKey;
